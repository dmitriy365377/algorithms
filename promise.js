...
// приходит 3 аргумента некоторые из них числа найти минимальное число бывает что чисел нет вообще
// сейчас нужно протестить массив от -100 до 100 во всех комбинациях

// describe it assertEquals

// let start = 100;
// let ressultArray = []

// for(start; start >= -100; start--) {
//   ressultArray.push(start--)
// } 


// console.log('ressultArray',ressultArray)

// function take3Numbers(ressultArray) {
//   const a
//   const b
//   const c
...
// console.log('>>', min(4, 2, 7, 9, 1, 3))

// const min = xs => -Math.max(xs.map(x => -x));
...
// function min(...args) {
//   const arr = [...args]
//   const filterNumber = arr.filter(arg => typeof arg === "number")
//   const minNumber = filterNumber.sort((a, b) => a - b)
//   if (minNumber.length !== 0) {
//     console.log('sds', minNumber[0]);
//   } else {
